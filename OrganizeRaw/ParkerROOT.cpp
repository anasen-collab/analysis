...
//      g++ -o ParkerROOT  organize_dictionary.cxx ParkerROOT.cpp `root-config --cflags --glibs`
...
int main(int argc, char* argv[]){
  ...
  */
  ...
  //EnergyLoss *E_Loss = new EnergyLoss("/home2/parker/ANASEN/LSU/CalParamFiles/Be7_D2_400Torr.eloss",M_Be7);
...
//------------Ion Chamber----------------------
	...
	MyFill("E_de",300,0,30,Tr.track_place_holder.SiEnergy,300,0,1,Tr.track_place_holder.PCEnergy*sin(Tr.track_place_holder.Theta));
