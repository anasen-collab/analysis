...
void print_hist_tree(void)
{
   ...
   for(DetNum=4;DetNum<6;DetNum++)
     {
       PlotCount=1;
   for(UpChNum=0;UpChNum<4;UpChNum++){     

   can[i]->cd(PlotCount); PlotCount++;
   hist1 = new TH1F(Form("det%i_up%i",DetNum,UpChNum),Form("det%i_up%i",DetNum,UpChNum),100,100,130);
