...
class Track {
 public:
  ...
  void zeroPlaceHolder(){
    ...
    BeEvent.ProtonEnergy = -10;
    BeEvent.ProtonEnergy_Rec = -10;
    BeEvent.ProtonDiffEnergy = -10;
    BeEvent.ProtonAngle = -10;
  ...
  static bool PC_sort_method(struct PropCounter_Event a,struct PropCounter_Event b);
