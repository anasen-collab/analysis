...
class ChannelMap {
  ...
  Double_t EdgeU, EdgeD, EdgeUp[NumX3][4][MaxX3Ch], EdgeDown[NumX3][4][MaxX3Ch];
  Double_t zerosh[MaxChNum],vperch[MaxChNum];
  Double_t ZOffset[NumX3],XAt0[NumX3],XAt4[NumX3],YAt0[NumX3],YAt4[NumX3];
  Double_t Voltage[MaxADC][MaxADCCh][MaxPulserPeaks],PCPulserPeak[MaxADC][MaxADCCh][MaxPulserPeaks];
  TRandom3 *XRandom2;
  TRandom3 *XYRandom;
...
public:
  ...
  void GetX3MeVPerChannel(Int_t DN, Int_t DetCh, Double_t& slope);
  void GetQQQ3MeVPerChannel(Int_t DN, Int_t DetCh, Double_t& slope);
  ...
  Double_t GetZeroShift(Int_t det, Int_t det_ch);
...
Double_t ChannelMap::GetZeroShift (Int_t det, Int_t det_ch)
{
...
void ChannelMap::GetPCWorldCoordinates(Int_t wireid, Double_t zpos, Double_t& xw, Double_t& yw, Double_t& zw, Double_t& rw, Double_t& phiw)
{
  ...
  Double_t Angle = ((Double_t)wireid+XYRandom->Rndm()-0.5)*TMath::TwoPi()/24.0 + TMath::Pi()/2;
...
void ChannelMap::GetX3MeVPerChannel(Int_t DN, Int_t DetCh, Double_t& slope)
{
  slope = X3RelativeSlope[DN-4][DetCh]*SiGains[DN];
}
//------------------------------------------------------------------------------------------------//

void ChannelMap::GetQQQ3MeVPerChannel(Int_t DN, Int_t DetCh, Double_t& slope)
{
  slope = QQQ3RelativeSlope[DN][DetCh]*SiGains[DN];
}
