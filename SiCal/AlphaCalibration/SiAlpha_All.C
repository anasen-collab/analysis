...
void SiAlpha_All(void)
{
  ...
  Float_t th228values[npeaks] = {5.42315,5.68537,6.05,6.28808,6.77803,8.74886};
  //Float_t th228values[npeaks] = {5.42315,5.68537,6.28808,6.77803,8.74886};
  ...
  TH1I *h1 = new TH1I("h1","h1",300,2500,7000);
  ...
  outfile.open("253SiAlpha_2016Jan22Back.dat");
  ...
  for (Int_t MBID=1; MBID<3; MBID++)
	...
	{ 
	  ...
	  if((CBID==3 || CBID==4 || CBID==7 || CBID==8) || (MBID==2 && (CBID==11 || CBID==12))){	 
		...
		Int_t nfound = s->Search(h1,10," ",0.2);
		...
		TGraph *FitGraph = new TGraph(nfound,xpeaks, &(th228values[0]));
		c1->cd(2);
