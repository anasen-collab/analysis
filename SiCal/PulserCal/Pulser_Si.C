...
#include "../../anasen_analysis_software/ChannelMap.h"
...
void Pulser_Si::Begin(TTree * /*tree*/) {
  ...
  CMAP = new ChannelMap();
  CMAP->Init("../../anasen_analysis_software/Param/map/ASICS_cmap_Final2015");
...
void Pulser_Si::Terminate() {
  ...
  ofstream outputfile;
  outputfile.open("saves/alignchannels.100912_2");
