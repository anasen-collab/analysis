...
//       g++ -o ParkerTrack organize_dictionary.cxx EnergyLoss.cpp ParkerTrack.cpp `root-config --cflags --glibs`
...
int main(int argc, char* argv[]){
  ...
  cut_protons1 = (TCutG*)cut_file2->Get("protons");
  ...
  EnergyLoss *E_Loss = new EnergyLoss("/home/manasta/Desktop/parker_codes/CalParamFiles/18Ne_in_HeCO2(4)_377Torr.txt",M_Beam);
...
//------------Ion Chamber & MCP & RF Timing----------------------
      ...
      // cout << Old_MCPTime << " " << Old_RFTime << endl;

      MyFill("Timing",600,1,600,fmod((MCPTime*correct-RFTime),546));

      //MyFill("Timing",600,1,600,(MCPTime-RFTime)%546);
	...
	Tr.track_place_holder.BeamEnergy = E_Loss->GetFinalEnergy(BeamE,La-Tr.track_place_holder.IntPoint,0.1);
